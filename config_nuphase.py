...
theta_i = 40        #if THROW_ELEVATION=False, send plane wave at theta_i
nevent  = 5000       #number of events to throw per snr step
...
OUTPUT_JSON_FILENAME='output/event_dict_2018-2-14-c.json'
